...
public enum ErrorCodeEnum {
    ...
    ACCOUNT_DETAILS_IMG_UPLOAD_FAILED_IO_EXCEPTION(70012, "上传账户账户明细凭证文件失败-IO异常"),
    ACCOUNT_DETAILS_IMG_UPLOAD_FAILED_PARAMETERS_ILLEGAL(70013, "上传账户账户明细凭证文件失败-参数异常"),
    ACCOUNT_DETAILS_IMG_UPLOAD_OK(70013, "上传账户账户明细凭证文件成功"),
